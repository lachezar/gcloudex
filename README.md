...
## Differences to previous `GCloudex` iterations

You may have seen previous iterations of this library and how it injects code
from implementation modules into empty modules. That's completely useless, so
I've removed that entirely. With time, things will simply be split out into
regular modules and used... as regular modules.

## Sasha Fonseca's original README.md
